...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Performance.comments'
        db.add_column(u'library_performance', 'comments',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Changing field 'Performance.place'
        db.alter_column(u'library_performance', 'place', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Deleting field 'Performance.comments'
        db.delete_column(u'library_performance', 'comments')

        # Changing field 'Performance.place'
        db.alter_column(u'library_performance', 'place', self.gf('django.db.models.fields.TextField')(max_length=1024))
